...
exports.verifyToken = exports.refreshAccessToken = exports.createRefreshToken = exports.createAccessToken = exports.createApiKey = void 0;
...
const refreshAccessToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const decoded = yield (0, exports.verifyToken)(refreshToken);
        const { id } = decoded;
        ...
        const newAccessToken = yield (0, exports.createAccessToken)(payload);
