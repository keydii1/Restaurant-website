...
router.patch("/edit/:id", checkAuth_auth_1.authAdmin, upload.single("image"), uploadCloud_middleware_1.uploadImage, blogValidate.titleLength, blogValidate.contentLength, controller.edit);
