...
router.patch("/edit/:id", checkAuth_auth_1.auth, tableValidate.tableNumberValid, tableValidate.tableNumberUnique, tableValidate.maximumCapacityValid, tableValidate.statusValid, tableValidate.positionLength, controllers.editTable);
