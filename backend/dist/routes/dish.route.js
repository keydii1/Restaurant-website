...
router.post("/create", upload.single("image"), uploadCloud_middleware_1.uploadImage, checkAuth_auth_1.authAdmin, controller.create);
router.get("/create", (req, res) => {
    res.render("product/upload_test.pug");
});
router.patch("/edit/:id", upload.single("image"), uploadCloud_middleware_1.uploadImage, checkAuth_auth_1.authAdmin, controller.edit);
