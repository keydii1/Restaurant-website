...
router.get("/", checkAuth_auth_1.authAdmin, controller.getAllOrders);
router.get("/my-orders", checkAuth_auth_1.auth, controller.getOrders);
router.get("/detail/:id", checkAuth_auth_1.authAdmin, controller.GetOrderDetail);
router.post("/create", checkAuth_auth_1.auth, controller.createOrder);
router.patch("/edit/:id", checkAuth_auth_1.auth, controller.updateOrder);
router.patch("/edit/:id/status", checkAuth_auth_1.authAdmin, controller.updateOrderStatus);
